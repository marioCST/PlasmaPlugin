...
public class RandCommand extends Command {
    ...
    public RandCommand(MarioMain plugin) {
        super("rand", "Öffnet eine UI für ein Plot Rand", "rand");
        this.setPermission("mario.rand");
        this.plugin = plugin;
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("mario.rand")) {
                if (args.length == 0) {
                    FormWindowSimple simple = new FormWindowSimple("§6Plot-Rand", "§6Wähle ein Plot-Rand aus!");
                    simple.addButton(new ElementButton("§8Luft"));
                    simple.addButton(new ElementButton("§8Glatte Steinstufe", new ElementButtonImageData("path", "textures/blocks/stone_slab_side.png")));
                    ...
                    simple.addButton(new ElementButton("§8Prismarinziegel", new ElementButtonImageData("path", "textures/blocks/prismarine_bricks.png")));
