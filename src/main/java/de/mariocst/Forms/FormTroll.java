...
public class FormTroll {
    ...
    public void openTroll(Player player) {
        SimpleForm form = new SimpleForm.Builder("§cTroll",
                ...
                .addButton(new ElementButton("§6Item Drop", new ElementButtonImageData("url", "https://raw.githubusercontent.com/marioCST/PlasmaPlugin/master/src/main/resources/textures/itemphysics.png")), e -> this.openItemDropMenu(player))
                .addButton(new ElementButton("§6Damage", new ElementButtonImageData("url", "https://raw.githubusercontent.com/marioCST/PlasmaPlugin/master/src/main/resources/textures/hitcolor.png")), e -> this.openDamageMenu(player))
